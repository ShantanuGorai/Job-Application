...
function FeaturesSection() {
  return (
    <section className="w-full bg-zinc-950 px-6 py-24 min-h-screen flex items-center justify-center">
      <div className="max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[200px]">
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-white font-medium">Resume Parsing</h3>
              <p className="text-gray-400 text-sm mt-1">Extract important information from resumes automatically.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-white font-medium">Personalized Job Search</h3>
              <p className="text-gray-400 text-sm mt-1">Find opportunities based on your profile and preferences.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-auto relative z-20 bg-zinc-900/50 backdrop-blur-sm rounded-lg p-2">
              ...
              <p className="text-gray-400 text-sm mt-1">Discover job opportunities from around the world.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-white font-medium">Smart Job Matching</h3>
              <p className="text-gray-400 text-sm mt-1">Match your skills with relevant job opportunities.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-400 text-sm mt-1">Protect your account with secure login and verification.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-white font-medium">Responsive Platform</h3>
