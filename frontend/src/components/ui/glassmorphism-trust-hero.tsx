...
const CLIENTS = [
  { name: 'Linkedin', icon: Hexagon },
  { name: 'Indeed', icon: Triangle },
  { name: 'Wellfound', icon: Command },
  { name: 'Cutshort', icon: Ghost },
  { name: 'naukri', icon: Gem },
  { name: 'Internshala', icon: Cpu },
];
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Turn your resume into opportunities with AI-powered job matching built around your skills,
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-zinc-400">Personalized Matching</div>
                  </div>
                </div>

                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Job Relevance</span>
                    <span className="text-white font-medium">98%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[90%] rounded-full bg-gradient-to-r from-white to-zinc-400" />
                  </div>
                </div>
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-[rgba(255,255,255,0.12)] bg-[rgba(30,42,35,0.85)] p-8 backdrop-blur-xl shadow-2xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">
                Search Across Leading Job Platforms
              </h3>
